...
> A small command line mastermind game for 1 player verse simple bot.
...
```bash
git clone https://github.com/Silas-N-Schlax/rm-prework-odin-mastermind.git
```
...
Bundle for Rubocop, and Colorize:
